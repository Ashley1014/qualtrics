...
Qualtrics.SurveyEngine.addOnReady(function()
{
    ...
    const eff = parseInt("${e://Field/lower_bound_eff_main_r1}");
    const trad = parseInt("${e://Field/lower_bound_trad_main_r1}");
    let basenum;
    ...
    function editLabels(QID, switchpoint, eff, trad) {
        ...
        let incr_trad;
        if (sp === 3) {
            init_eff = parseInt("${e://Field/lower_bound_eff_main_r1}");
            init_trad = parseInt("${e://Field/lower_bound_trad_main_r1}");
            if (effLeft) {
                incr_eff = 1;
                incr_trad = -1;
            } else {
