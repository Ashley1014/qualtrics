...
Qualtrics.SurveyEngine.addOnReady(function()
{
    ...
    function calculate_wtp(QID, value) {
        ...
        Qualtrics.SurveyEngine.setEmbeddedData("upper_bound_led", upper_bound_led_cp);
        Qualtrics.SurveyEngine.setEmbeddedData("upper_bound_hal", upper_bound_hal_cp);
        Qualtrics.SurveyEngine.setEmbeddedData("lower_bound_led", lower_bound_led_cp);
        Qualtrics.SurveyEngine.setEmbeddedData("lower_bound_hal", lower_bound_hal_cp);
        ...
        Qualtrics.SurveyEngine.setEmbeddedData("initial_list_value_led", lower_bound_led_cp);
        Qualtrics.SurveyEngine.setEmbeddedData("initial_list_value_hal", lower_bound_hal_cp);
    }
