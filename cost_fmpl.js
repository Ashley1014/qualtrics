...
Qualtrics.SurveyEngine.addOnReady(function()
{
    ...
    function clearSelection() {
        //debugger;
        const back_revise = parseInt("${e://Field/back_revise_cost}");
    ...
    function findInfo(sp) {
        ...
        let init_swi = parseFloat("$e{ ( e://Field/lower_bound_cost + e://Field/cost_fmpl_incr_swi ) }");
        //@TODO: ** change the eff fmpl init price variable when there's a switchpoint and when choice_b is eff **
        let init_ally = parseFloat("$e{ ( e://Field/lower_bound_cost + e://Field/cost_fmpl_incr_ally ) }");
        //@TODO: ** change the trad fmpl init price variable when there's a switchpoint and when choice_a is trad **
        let init_alln = parseFloat("$e{e://Field/cost_fmpl_init_alln}");
        let incr_swi = parseFloat("${e://Field/cost_fmpl_incr_swi}");
        let incr_ally = parseFloat("${e://Field/cost_fmpl_incr_ally}");
        let incr_alln = parseFloat("${e://Field/cost_fmpl_incr_alln}");
    ...
    function findSwitchPoint(qid) {
        ...
        //console.log("your cost fmpl switch point is ", switch_point);
        sp = switch_point;
    ...
    function calculate_wtp(QID) {
        ...
        let main_sp = parseInt("${e://Field/switchpoint_cost_main}");
